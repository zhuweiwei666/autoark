 ...
 * - Facebook API bug 回溯
 */
const rawInsightsSchema = new mongoose_1.default.Schema({
    // 标识字段
    ...
    purchase_roas: mongoose_1.default.Schema.Types.Mixed, // Array or single value
    // 提取的 purchase 相关数据
...
rawInsightsSchema.index({ adId: 1, date: 1, country: 1, datePreset: 1 }, { unique: true });
// 查询索引
...
exports.default = mongoose_1.default.model('RawInsights', rawInsightsSchema);
