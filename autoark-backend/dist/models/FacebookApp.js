...
const facebookAppSchema = new mongoose_1.default.Schema({
...
// 虚拟字段：是否可用
facebookAppSchema.virtual('isAvailable').get(function () {
...
facebookAppSchema.virtual('isPublicOauthReady').get(function () {
...
exports.default = mongoose_1.default.model('FacebookApp', facebookAppSchema);
