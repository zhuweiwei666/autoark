...
exports.trendService = exports.TrendService = void 0;
/**
 * 趋势分析服务
...
class TrendService {
     ...
     */
    calculateEMA(sequence, alpha = 0.3) {
     ...
     */
    getTrendMultiplier(slope, direction, sensitivity = 0.1) {
        // 动能分 = 斜率 * 预期方向 * 敏感度
...
exports.trendService = new TrendService();
