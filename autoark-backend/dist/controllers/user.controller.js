...
class UserController {
    ...
    async getUsers(req, res) {
        try {
            ...
            const users = await user_service_1.default.getUsers(req.user, filters);
            res.json({
                success: true,
                data: users,
            });
    ...
    async getUserById(req, res) {
        try {
            ...
            const user = await user_service_1.default.getUserById(req.params.id, req.user);
            res.json({
                success: true,
                data: user,
            });
    ...
    async createUser(req, res) {
        try {
            ...
            const user = await user_service_1.default.createUser({ username, password, email, role, organizationId }, req.user);
            res.status(201).json({
                success: true,
                data: user,
            });
    ...
    async updateUser(req, res) {
        try {
            ...
            const user = await user_service_1.default.updateUser(req.params.id, req.body, req.user);
            res.json({
                success: true,
                data: user,
            });
    ...
    async deleteUser(req, res) {
        try {
            ...
            await user_service_1.default.deleteUser(req.params.id, req.user);
            res.json({
                success: true,
                message: '用户删除成功',
            });
    ...
    async updateUserStatus(req, res) {
        try {
            ...
            const user = await user_service_1.default.updateUserStatus(req.params.id, status, req.user);
            res.json({
                success: true,
                data: user,
            });
    ...
    async resetPassword(req, res) {
        try {
            ...
            await user_service_1.default.resetUserPassword(req.params.id, newPassword, req.user);
            res.json({
                success: true,
                message: '密码重置成功',
            });
