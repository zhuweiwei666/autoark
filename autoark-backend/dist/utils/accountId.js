...
exports.normalizeForStorage = normalizeForStorage;
exports.normalizeForApi = normalizeForApi;
exports.normalizeArrayForStorage = normalizeArrayForStorage;
exports.normalizeArrayForApi = normalizeArrayForApi;
exports.getAccountIdsForQuery = getAccountIdsForQuery;
exports.normalizeFromQuery = normalizeFromQuery;
/**
 ...
 */
function normalizeForStorage(accountId) {
    if (!accountId)
        return '';
 ...
 */
function normalizeForApi(accountId) {
    if (!accountId)
        return '';
 ...
 */
function normalizeArrayForStorage(accountIds) {
 ...
 */
function normalizeArrayForApi(accountIds) {
 ...
 */
function getAccountIdsForQuery(accountIds) {
 ...
 * @returns 不带 act_ 前缀的 accountId
 */
function normalizeFromQuery(accountId) {
