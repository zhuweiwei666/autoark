  ...
  try {
    ...
    await writeAuditLog(req, {
      ...
      metadata: {
        ...
        buildRef: data.system?.build?.ref,
        buildCommit: data.system?.build?.commit,
        buildShortCommit: data.system?.build?.shortCommit,
        buildDeployedAt: data.system?.build?.deployedAt,
        ...
        facebookAppCount: data.facebookApps?.summary?.total,
        publicOauthReadyAppCount: data.facebookApps?.summary?.ready,
        publicOauthBlockedAppCount: data.facebookApps?.summary?.blocked,
        publicOauthGapCount: data.facebookApps?.summary?.totalGaps,
        firstPublicOauthGap: data.facebookApps?.apps?.find((app: any) => !app.publicOauthReady)?.gaps?.[0]?.label,
