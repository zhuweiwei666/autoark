        ...
        <section className="bg-white rounded-3xl p-6 shadow-lg shadow-black/5 border border-slate-200">
          <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-4 items-end">
            ...
            <button
              ...
              disabled={isFetching}
              className={`w-full px-4 py-3 bg-blue-600 hover:bg-blue-700 rounded-2xl text-sm font-semibold text-white transition-all shadow-md hover:shadow-lg active:scale-95 flex items-center justify-center gap-2 ${
